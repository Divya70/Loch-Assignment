...
const testimonals = [
  <div className="box-testi">
    <p>
      {" "}
      <span className="fname">JACK F </span>
      <span className="lname">Ex Blackrock PM</span>
    </p>
    <p className="testi-p">
  ...
  <div className="box-testi">
    <p>
      {" "}
      <span className="fname">YASH P </span>
      <span className="lname">Research, 3poch Crypto Hedge Fund</span>
    </p>
    <p className="testi-p">
  ...
  <div className="box-testi box-3">
    <p>
      {" "}
      <span className="fname">SHIV S </span>
      <span className="lname">Co-Founder Magik Labs</span>
    </p>
    <p className="testi-p">
